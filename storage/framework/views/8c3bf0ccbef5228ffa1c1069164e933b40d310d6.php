                        ...
                        <tbody>
                            ...
                            <tr class="bp<?php echo e($bp->id); ?>">
                                ...
                                <td><button data-id="<?php echo e($bp->id); ?>" class="btn btn-sm btn-primary fa fa-pencil edit-bp" onclick=""></button>
                                    ...
                                    <!-- <a href="<?php echo e($bp->id); ?>" class="btn btn-sm btn-ifo fa fa-trash del-bp"></a> -->
                                  </td>
                            </tr>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input class="form-control" value="<?php echo e(old('systolic')); ?>" name="systolic" type="text">
                                </div>
                                <div class="col-md-6 form-group ">
                                    <label>Diastolic</label>
                                    <input class="form-control"  value="<?php echo e(old('diastolic')); ?>" name="diastolic" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Pulse</label>
                                    <input class="form-control"  value="<?php echo e(old('pulse')); ?>" name="pulse" type="text">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Tel</label>
                                    <input class="form-control"  value="<?php echo e(old('tel')); ?>" name="tel" type="text">
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label>IMEI</label>
                                    <input class="form-control" value="<?php echo e(old('imei')); ?>"  name="imei" type="text">
                                </div>
                                <div class="form-group col-md-4">
                                    <label>IMSI</label>
                                    <input class="form-control"  value="<?php echo e(old('imsi')); ?>" name="imsi" type="text">
                                </div>
                            
                                <div class="form-group col-md-4">
                                    <label>ICCID</label>
                                    <input class="form-control" value="<?php echo e(old('iccd')); ?>" name="iccid" type="text">
                                </div>
                            </div>
                        </div>
