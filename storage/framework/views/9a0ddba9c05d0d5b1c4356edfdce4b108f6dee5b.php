          ...
          <div class="row">
             ...
             <div class="col-xl-4 col-sm-6 mb-3" style="padding-left: 10%;">
                  <canvas data-type="linear-gauge"
                    ...
                    data-bar-width="20"
                    data-value="<?php if(isset( $bgs )): ?><?php echo e($bgs[0]->bg); ?> <?php endif; ?>"
                ></canvas>
              <h5 style="margin-left: -40px; margin-bottom: -20px; color: #aaa !important;">Glucose: <?php if(isset( $bgs )): ?><?php echo e($bgs[0]->bg); ?> <?php endif; ?></h5><br>
              <small class="text-center ml-4">(<?php if(isset( $bgs )): ?><?php echo e($bgs[0]->created_at->diffForHumans()); ?> <?php endif; ?>)</small>
              </div>
