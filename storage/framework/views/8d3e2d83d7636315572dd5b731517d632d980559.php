                ...
                <div class="row center-block">
                    <div class="col-md-12">
                        <div class="form-group ui-widget">
                            <label>Name</label>
                            <input class="form-control shadow <?php echo e($errors->has('name') ? ' is-invalid' : ''); ?>" value="<?php echo e(old('name')); ?>" name="name" type="text" id="drug_name" placeholder="Adenoscan, Ernthyomacin">
                    ...
                    <div class="col-md-12 form-group">
                        <label>Dosage</label>
                        <input type="text" name="dosage" class="form-control shadow" value="<?php echo e(old('dosage')); ?>" placeholder="5 mg, 200IU">
                    </div>
                    <div class="col-md-12 form-group">
                        <label>Frequency(per day)</label>
                        <input type="text" name="frequency" class="form-control shadow" value="<?php echo e(old('frequency')); ?>" placeholder="2 times a day...">                  
                    </div>
                    <div class="col-md-12 form-group">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input name="start_date" type="date" class="form-control shadow" value="<?php echo e(old('start_date')); ?>">
                    </div>
                    <div class="col-md-12 form-group">
                        <label for="start_date">End Date</label>
                        <input name="end_date" type="date" class="form-control shadow" value="<?php echo e(old('end_date')); ?>">
                    </div>
                    <br>
