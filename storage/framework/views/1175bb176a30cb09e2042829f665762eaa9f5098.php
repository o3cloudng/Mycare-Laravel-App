                    ...
                    <div class="list_general" style="margin-left: -30px;">
                        <ul class="d-flex justify-content-around">
                            <li class="text-center round_box activeBPLink text-white justify-content-center">
                                ...
                                <?php if(isset($bloodGlucoseGoal)): ?> <?php echo e($bloodGlucoseGoal->bg_goal); ?> <?php else: ?> No Value <?php endif; ?> </li>
                            <!-- <li class="text-center round_box activeBPLink text-white justify-content-center">
                                <br><strong>Diastolic</strong> <br/> 
                                <?php if(isset($bloodGlucoseGoal)): ?> <?php echo e($bloodGlucoseGoal->diastolic); ?> <?php else: ?> No Value <?php endif; ?></li>
                            <li class="text-center round_box activeBPLink text-white justify-content-center">
                                <br><strong>Frequency</strong> <br/> 
                                <?php if(isset($bloodGlucoseGoal)): ?> <?php echo e(ucfirst($bloodGlucoseGoal->frequency)); ?> <?php else: ?> No Value <?php endif; ?></li> -->
                        </ul>
                        <p class="text-center ml-5">
                        ...
                        <ul>
                            <li>
                                <p class="text-center">
                                    <ul class="buttons">
                                        <?php if(isset($bloodGlucoseGoal)): ?>
                                            <?php if($bloodGlucoseGoal->status == 'activate'): ?>
                                                <li><br><a href="#0" class="btn_1 btn btn-inverse btn2 shadow gray"><i class="fa fa-fw fa-times-circle-o"></i> Deactivate</a></li> 
                                            <?php else: ?>
                                                 <li><a href="#0" class="btn_1 btn btn2 shadow gray approve"><i class="fa fa-fw fa-check-circle-o"></i> Activate</a></li>
                                            <?php endif; ?>
                            ...
                            <div class="list_general">
                                <ul class="d-flex justify-content-around">
                                    <li class="text-center round_box activeBPLink text-white justify-content-center" style="margin-left: -40px;">
                                        ...
                                        <?php if(isset($bmiGoal)): ?> <?php echo e($bmiGoal->bmi); ?> <?php else: ?> No Value <?php endif; ?> </li>
                                </ul>
                                ...
                                <p class="buttons">
                                    <?php if(isset($bmiGoal)): ?>
                                        <?php if($bmiGoal->status == 'activate'): ?>
                                            <li><button id="activateOrDeactivateBMI" data-id=<?php echo e($bmiGoal->id); ?> class="btn_1 gray"><i class="fa fa-fw fa-times-circle-o"></i> Deactivate</button></li> 
                                        <?php else: ?>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <label>BMI</label>
                                        <input name="bmi" type="number" value="<?php if(isset($bmiGoal)): ?><?php echo e($bmiGoal->bmi); ?><?php endif; ?>" class="form-control shadow" step="any">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input name="bg_goal" type="number" value="<?php if(isset($bloodGlucoseGoal->bg_goal)): ?><?php echo e($bloodGlucoseGoal->bg_goal); ?><?php endif; ?>" class="form-control shadow" step="any">
                                    </div>
                                </div>
