    ...
    <div class="row">
        <div class="col-md-2 h-100 sticky-top hidden-md-down" id="sidebar">
            <div class="text-center">
                ...
                <div class="text-left ml-2">
                    ...
                    <a href="/contact-team" class="list-group-item"><img src="<?php echo e(asset('img/svg/icons/contact_team.svg')); ?>" class="menu_icon" /> Care Team</a>
        ...
        <div class="col-md-10 w-100" style="height:100%;">
            <nav class="navbar navbar-expand-md bg-dark navbar-dark d-sm-block d-md-none">
              ...
              <span class="align-items-center align-middle">Hi <?php echo e($subscriber->phone); ?>,</span>
              ...
              <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a href="/contact-team" class="nav-link"><img src="<?php echo e(asset('img/svg/icons/contact_team.svg')); ?>" class="menu_icon" /> Care Team</a>
                  </li>
                  <li class="nav-item">
