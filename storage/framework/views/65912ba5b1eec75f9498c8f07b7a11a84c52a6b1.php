      ...
      <!-- WEB NAVIGATION CODE -->
        <div class="col-md-2 h-100 sticky-top hidden-md-down" id="sidebar">
            <div class="text-center">
                <a href="/"><img class="img-rounded rounded mt-4" style="width: 200px; margin-left: -20px !important;" src="<?php echo e(asset('img/svg/logo.svg')); ?>" /></a>
                <br>
                ...
                <div class="text-left ml-2">
                    <a href="/dashboard" class="list-group-item <?php if(Request::is('dashboard')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/dashboard.svg')); ?>" class="menu_icon" /> Dashboard</a>
                    ...
                    <a href="/personal_profile" class="list-group-item <?php if(Request::is('personal_profile')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/medical_personel.svg')); ?>" class="menu_icon" /> Personal Profile</a>
                    <a href="/med_records" class="list-group-item <?php if(Request::is('med_records')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/medical_records.svg')); ?>" class="menu_icon" /> Medical Records</a>
                    <a href="/contact-team" class="list-group-item <?php if(Request::is('contact-team')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/contact_team.svg')); ?>" class="menu_icon" /> Contact Team</a>
                    <!-- <a href="/medical_personel" class="list-group-item <?php if(Request::is('medical_personel')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/medical_personel.svg')); ?>" class="menu_icon" /> Medical Personal</a> -->
                    <a href="medications" class="list-group-item <?php if(Request::is('medications')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/medication.svg')); ?>" class="menu_icon" /> Medication</a>
                    <a href="/goals" class="list-group-item <?php if(Request::is('goals')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/goals.svg')); ?>" class="menu_icon" /> Goal</a>
                    <a href="/subscriptions" class="list-group-item <?php if(Request::is('subscriptions')): ?> activeNav <?php endif; ?>"><img src="<?php echo e(asset('img/svg/icons/subscription.svg')); ?>" class="menu_icon" /> Subscription</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-10 w-100 cover-width" style="height:100%;">
            <nav class="navbar navbar-expand-md bg-dark navbar-dark d-sm-block d-md-none">
              ...
              <a class="navbar-brand" href="/"><img style="width: 70px; height:30px;" src="<?php echo e(asset('img/logo.jpeg')); ?>" /></a>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-8 top-link">
                                    <div class="row">
                                      <div class=" col-md-6 d-flex justify-content-center">
                                        <a href="/blood_pressures" id="mybp" class="btn btn2 button shadow mr-2 <?php if(Request::is('blood_pressures')): ?> activeBPLink <?php endif; ?>">MYBP</a>
                                        <a href="/blood_glucoses" id="mybg" class="btn btn2 button shadow mr-2 <?php if(Request::is('blood_glucoses')): ?> activeBPLink <?php endif; ?>">MYBG</a>
                                        <a href="/mybump" id="mybump" class="btn btn2 button shadow <?php if(Request::is('mybump')): ?> activeBPLink <?php endif; ?>">MYBUMP</a>
                                      </div>
