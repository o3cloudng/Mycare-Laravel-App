                        ...
                        @if( count($careTeams) > 0 )
                            ...
                            @foreach($careTeams as $careTeam)
                                <tr>
                                    ...
                                    <td><a href="javascript:void(0);" onclick="addUserToCareTeam({{ $careTeam->id }})" class="btn_1 gray approve wishlist_close"><i class="fa fa-fw fa-times-circle-o"></i> Request Connection</a></td>
                                </tr>
                            @endforeach
                        @else
                            <tr>
