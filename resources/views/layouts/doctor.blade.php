...
<!-- TOP NAV MENU -->
      <ul class="navbar-nav ml-auto">
       {{-- <li class="nav-item">
        ...
        <li class="nav-item">
              <a class="nav-link" href="/personal_profile">
                  <span class="nav-link-text"><img class="img-responsive rounded-circle" style="width: 25px;margin-top: 0px;padding-bottom: 0px; background: white;" src="{{  isset($subscriber->avatar) ? asset('/storage/'.$subscriber->avatar): asset('/img/avatar.png') }}" /></span>
                </a>
          </li>
        <li class="nav-item">
          <a class="nav-link" href="#"
